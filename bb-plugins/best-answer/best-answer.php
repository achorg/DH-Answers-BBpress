...
$best_answer['icon']=bb_get_option('uri').trim(str_replace(array(trim(BBPATH,"/\\"),"\\"),array("","/"),dirname(__FILE__)),' /\\').'/check.png';  // image auto-discovery
$best_answer['css']="
	.best_answer {text-decoration:none; border:0; white-space:nowrap; display:block; margin:1em 0;		
		border:0; text-decoration:none; padding-left:24px; width:19px; height:16px;
	...
	a.best_answer:hover {color:#84DB8B; background-position:0px 0px;}	
